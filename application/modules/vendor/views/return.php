                ...
                <tbody>
                    ...
                    foreach ($orders as $tr) {
                        ...
                        <tr>
                            ...
                            <td>
                            	 <?php if($tr['warehouse_return_date']!="") echo date('d.M.Y / H:i:s', strtotime($tr['warehouse_return_date'])); ?></td>
                            </td>
                            <td class="<?= $class ?> text-center"> -- <b><?= $type ?></b> --
                            <?php if($tr['return_status'] != 'return_processing' && $tr['return_accepted_at_warehouse']==""){?>
