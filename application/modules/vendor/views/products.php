                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            <a href="<?= base_url('vendor/edit/product/' . $row->id) ?>" class="btn btn-info">Edit</a>
                                            <a href="<?= base_url('vendor/products?delete=' . $row->id) ?>"  class="btn btn-danger confirm-delete">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
