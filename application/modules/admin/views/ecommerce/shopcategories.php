            ...
            <table class="table table-striped custab">
                ...
                foreach ($shop_categories as $key_cat => $shop_categorie) {
                    ...
                    <tr>
                       ...
                       <td>
                       		 <a href="javascript:void(0);" class="editTag" data-position-for-id="<?= $key_cat ?>" data-my-position="<?= $shop_categorie['tag'] ?>">
                                <i class="fa fa-pencil" aria-hidden="true"></i>
                            </a>
                            <span id="tag-<?= $key_cat ?>"><?= $shop_categorie['tag'] ?></span>
                       </td>
            ...
            <div class="modal-content">
                <form action="" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                                <label>Tag (<?= $language->tag ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
                                <input type="text" name="categorie_tag" class="form-control">
                        </div>
                    </div>
...
<div id="tagEditor">
    <input type="hidden" name="tagEditId" value="">
    <input type="text" name="new_tag" class="form-control" value="">
    <button type="button" class="btn btn-default saveTagCategorie">
        <i class="fa fa-floppy-o noSavePosition" aria-hidden="true"></i>
        <i class="fa fa-spinner fa-spin fa-fw yesSavePosition"></i>
    </button>
    <button type="button" class="btn btn-default closeTagCategorie"><i class="fa fa-times" aria-hidden="true"></i></button>
</div>
