...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if ($this->session->flashdata('facebook_login')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('facebook_login') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <input type="hidden" name="facebook_login" value="<?= $facebook_login ?>">
                    <input <?= $facebook_login == 1 ? 'checked' : '' ?> data-toggle="toggle" data-for-field="facebook_login" class="toggle-changer" type="checkbox">
                    <button class="btn btn-default" value="" type="submit">
                        Save
                    </button>
                </form>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if ($this->session->flashdata('google_login')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('google_login') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <input type="hidden" name="google_login" value="<?= $google_login ?>">
                    <input <?= $google_login == 1 ? 'checked' : '' ?> data-toggle="toggle" data-for-field="google_login" class="toggle-changer" type="checkbox">
                    <button class="btn btn-default" value="" type="submit">
                        Save
                    </button>
                </form>
