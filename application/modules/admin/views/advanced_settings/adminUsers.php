        ...
        <div class="table-responsive">
            <table class="table table-striped custab">
                ...
                <?php foreach ($users->result() as $user) {
					 $display_user = true;
					 if($this->session->userdata('logged_in')!='admin' && $user->username == "admin")
					 $display_user = false;
                        ...
                        <div class="form-group">
                            ...
                            <select name="level" class="form-control">
                            	<?php foreach($users_level->result() as $level){
								    ...
								    if($display_level){
									?>
                            	<option <?php if(isset($_POST['level']) && ($_POST['level'] == $level->user_level_id)) echo 'selected="selected"';?> value="<?php echo $level->user_level_id;?>"><?php echo $level->user_level_name;?></option>
                                <?php } } ?>
                            </select>
                        </div>
