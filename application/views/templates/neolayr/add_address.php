                        ...
                        <div class="row">
                              ...
                              <div class="each-feild each-feilds">
                                 <div class="row">
                                    <div id="" class="col-lg-12">
                                       ...
                                       <input type="text" class="input-style" placeholder=" Name" required="required" name="add_name" />
                                    </div>
                                    <!-- <div id="" class="col-lg-6">
                                       <lable class="info-label-style">Last Name</lable>
                                       <input type="text" class="input-style" placeholder="Last Name" required="required" name="add_last_name" />
                                       </div> -->
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds">
                                 ...
                                 <input type="phone" class="input-style new-input-style" placeholder="Mobile Number" required="required" name="add_mob" maxlength="10" onkeypress="return isNumber(event)"/>
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds">
                                 <label class="info-label-style">Pincode *</label>
                                 <input type="phone" class="input-style new-input-style" placeholder="Pincode" required="required" name="add_pincode" maxlength="6" id="add_pincode"/>
                              </div>
                           </div>
                           <!-- <div class="col-lg-12"></div> -->
                           <!-- <div class="col-lg-6">
                           ...
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds">
                                 ...
                                 <input type="text" name="add_state" id="stateInput" class="input-style new-input-style add_state" placeholder="State" required="required">
                                 ...
                                 <!-- <input type="phone" class="input-style new-input-style" placeholder="State"/> -->
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds">
                                 <label class="info-label-style">City *</label>
                                 <input type="text" name="add_city" id="thana" class="input-style new-input-style" placeholder="City" required="required">
                                 <!-- <select name="add_city" id="thana" class="add-field input-style new-input-style" required="required">
                                    <option value="">-</option>
                                    </select> -->
                                 <!-- <input type="phone" class="input-style new-input-style" placeholder="City"/> -->
                              </div>
                           </div>
                           <div class="col-lg-12"></div>
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds">
                                 ...
                                 <input type="text" class="input-style new-input-style" placeholder="House No., Building Name" required="required" name="add_build_name" />
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds">
                                 <label class="info-label-style">Road Name, Area, Colony *</label>
                                 <input type="text" class="input-style new-input-style" placeholder="Road Name, Area, Colony" required="required" name="add_road_name" />
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds">
                                 <label class="info-label-style">Landmark</label>
                                 <input type="text" class="input-style new-input-style" placeholder="Landmark"  name="landmark" />
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="each-feild each-feilds each-feilds-btn">
                                 <button type="submit" class="gn-button small new-input-style add_address_profile" name="add_address">Save Address</button>
                              </div>
                           </div>
                        </div>
                     </div>
