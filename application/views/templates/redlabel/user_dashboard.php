      ...
      <div class="my-account loginmodal-container">
        <h1>
          <div class="sidebar-menu">
            <ul class="list-inline">
              <li class="active"> <a href="<?= LANG_URL . '/users/dashboard' ?>"> <i class="fa fa-dashboard" aria-hidden="true"></i>
                <?= lang('vendor_dashboard') ?>
                </a> </li>
      ...
      <div class="content-right clearfix">
        <div class="my-dashboard">
          <div class="recent-orders index-table">
            <h4 class="section-header"> Recent Orders <a href="<?= LANG_URL . '/users/orders' ?>" class="pull-right"> View All </a> </h4>
          ...
          <div class="account-information clearfix">
            ...
            <div class="col-md-6">
              <div class="row">
                <div class="contact-information"> <span><?= strtoupper($userInfo['name']); ?> </span> <span><?= $userInfo['email']; ?></span> <a href="<?= LANG_URL . '/users/profile' ?>"> Edit </a> </div>
              </div>
            </div>
          </div>
        </div>
