    ...
    <body>
        <div id="wrapper">
            <div id="content">
                                            ...
                                            <td>
                                                <div class="center">
                                                    <?php if(!isset($_SESSION['logged_user'])){?>
                                                     <h4>Guest</h4>
                                                    <a href="<?= LANG_URL . '/users/login' ?>"><?= lang('u_login') ?></a> |
                                                    <a href="<?= LANG_URL . '/users/register' ?>"><?= lang('register_me') ?></a>
                                                    <?php } else{?>
                                                     <h4><?= $_SESSION['logged_user_name'];?></h4>
                                                     <a href="<?= LANG_URL . '/users/orders' ?>"><?= lang('your_order') ?></a> |
                                                    <a href="<?= LANG_URL . '/users/logout' ?>"><?= lang('logout') ?></a>
                                                    <?php } ?>
                                                </div>
                                            </td>
                                            <td>
                ...
                <nav class="navbar gradient-color <?php echo $this->router->fetch_class().' '.$this->router->fetch_method();?>">
                    <div class="container">
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav" style="<?= $naviText == null ? 'margin-left:-15px;' : '' ?>">
                                ...
                                if (!empty($dynPages)) {
                                    ...
                                    ?><?php */?>
                                <li<?= uri_string() == 'checkout' || uri_string() == MY_LANGUAGE_ABBR . '/checkout' ? ' class="active"' : '' ?>><a href="<?= LANG_URL . '/users/dashboard' ?>"><?= lang('my_acc') ?></a></li>
