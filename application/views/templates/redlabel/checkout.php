        ...
        <div class="row">
            <div class="col-sm-9 left-side">
                    ...
                    <div class="row">
                       ...
                       <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <select name="city" class="form-control" onChange="changeDeliveryCharge(this.value);">
                            <?php foreach($district_list as $district){
									if($district['is_default'] == 'yes')
									$default_delivery_charges = $district['delivery_charges'];
							?>
                             <option <?php if($district['is_default'] == 'yes') echo 'selected="selected"';?>  value="<?php echo $district['state_name'].",".$district['delivery_charges'].",".$district['delivery_time'].",".$district['district_id'];?>"><?php echo $district['state_name'];?></option>
                             <?php } ?>
                            </select>
                        </div>
                        <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                            <label for="postInput">State</label>
                            <select name="thana" id="thana" class="form-control" >
                                                	<?php foreach($thana_list as $thana){?>
                                                	<option value="<?php echo $thana['name'];?>"><?php echo $thana['name'];?></option>
                                                    <?php } ?>
                            </select>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-products">
                            ...
                            <tbody>
                                ...
                                <?php $price = str_replace(",", "", $item['price']);  $total_price+=($price*$item['num_added']); } ?>
                                ...
                                <tr id="discount_row" style="display:none;">
                                     ...
                                     <td><span id="discount-amount">0</span><?= CURRENCY ?></td>
                                </tr>
                                <tr>
                                	 <td colspan="4" class="text-right">Delivery Charge</td>
                                     <td><span id="delivery_charges"><?= number_format($default_delivery_charges,2)?></span><?= CURRENCY ?></td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right"><?= lang('total') ?></td>
                                    <td>
                                        <span id="total_price" class="final-amount"><?= number_format($total_price+$default_delivery_charges,2) ?></span><?= CURRENCY ?>
                                        <input  type="hidden" id="shpping_cost" name="shpping_cost" value="<?php echo number_format($default_delivery_charges,2);?>" />
                                        <input type="hidden" id="final-amount" name="final_amount" value="<?= $total_price+$default_delivery_charges ?>">
                ...
                <div>
                    ...
                    <a href="javascript:void(0);" class="btn btn-primary go-order pull-right" onclick="document.getElementById('goOrder').submit();">
                        <?= lang('custom_order') ?> 
