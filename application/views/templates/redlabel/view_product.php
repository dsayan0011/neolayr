    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="product-right">
                        <h2><?= $product['title'] ?></h2>
                        <?php if($product['old_price']!=""){?><h4><del><?= number_format($product['old_price'],2) . CURRENCY ?></del><span><?php echo number_format((($product['old_price']-$product['price'])*100)/$product['old_price']);?>% off</span></h4><?php } ?>
                        <h3><?= number_format($product['price'],2) . CURRENCY ?></h3>
                        <div class="product-description border-product">
                        	<?php if ($product['quantity'] > 0) { ?>
                            <b><?= lang('in_stock') ?>:</b><?= $product['quantity'] ?>
                            <?php }else{ ?>
                            <b><span class="out_stock"><?= lang('out_of_stock_product') ?></span></b>
                            <?php } ?>
                        </div>
                        ...
                        <div class="product-buttons">
                        	<?php if ($product['quantity'] > 0) { ?>
                            <a href="javascript:void(0);" data-id="<?= $product['id'] ?>" data-goto="<?= LANG_URL . '/checkout' ?>" class="add-to-cart btn-custom">
                            <span class="text-to-bg"><?= lang('buy_now') ?></span>
                            </a>
                            <a href="javascript:void(0);" data-id="<?= $product['id'] ?>" class="add-to-cart btn-custom">
